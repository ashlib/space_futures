...
function keyPressed() {
	...
	if (state == 2) {
		if (key === 'a') { aKey = true; wrongKey = true;}
		if (key === 'b') { bKey = true; wrongKey = true;}
		if (key === 'c') { cKey = true; wrongKey = true;}
		if (key === 'd') { dKey = true; wrongKey = true;}
		if (key === 'e') { eKey = true; wrongKey = true;}
		if (key === 'f') { fKey = true; wrongKey = true;}
		if (key === 'g') { gKey = true; wrongKey = true;}
		if (key === 'h') { hKey = true; wrongKey = true;}
		if (key === 'i') { iKey = true; wrongKey = true;}
		if (key === 'j') { jKey = true; wrongKey = true;}
		if (key === 'k') { kKey = true; wrongKey = true;}
		if (key === 'l') { lKey = true; wrongKey = true;}
		if (key === 'm') { mKey = true; wrongKey = true;}
		if (key === 'n') { nKey = true; wrongKey = true;}
		if (key === 'o') { oKey = true; wrongKey = true;}
		if (key === 'p') { pKey = true; wrongKey = true;}
		if (key === 'q') { qKey = true; wrongKey = true;}
		if (key === 'r') { rKey = true; wrongKey = true;}
		if (key === 's') { sKey = true; wrongKey = true;}
		if (key === 't') { tKey = true; wrongKey = true;}
		if (key === 'v') { vKey = true; wrongKey = true;}
		if (key === 'w') { wKey = true; wrongKey = true;}
		if (key === 'x') { xKey = true; wrongKey = true;}
		if (key === 'y') { yKey = true; wrongKey = true;}
	}
}
...
Galaxy.prototype.run = function() {
    var s;//draw flashlight and sync to mouse
//buckets go faster..
//music??
